...
function animateNumber(el, target, prefix, suffix, decimals, pop) {
  if(!el) return;
  ...
  function step(now) {
    ...
    else if(pop){ el.classList.remove('num-pop'); void el.offsetWidth; el.classList.add('num-pop'); }
  }
