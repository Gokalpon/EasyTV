...
| 02:08 | iPhone test raporundaki mock veri sorunu için kullanýcý akýþý ve kod audit edildi | app.js, payment-service.js, supabase_setup.sql | release blocker listesi çýkarýldý, henüz kod fix yok | ~tokens |
